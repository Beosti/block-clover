...
@OnlyIn(Dist.CLIENT)
public class AbilityProjectileRenderer<T extends SpellProjectileEntity, M extends EntityModel<T>> extends EntityRenderer<T>
{
	...
	public static class Factory implements IRenderFactory<SpellProjectileEntity>
	{
		...
		@Override
		public EntityRenderer<? super SpellProjectileEntity> createRenderFor(EntityRendererManager manager)
		{
