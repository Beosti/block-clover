...
public class ModSpells {
    ...
    public static final Spell[] WATER = new Spell[] {WaterballSpell.INSTANCE, CurrentOfTheFortuneRiverSpell.INSTANCE, WaterSubstituteSpell.INSTANCE, HolyFistofLoveSpell.INSTANCE};
